...
//            System.out.println(node + " : "  + node.getClass().getName());
    ...
    private static void new_main(String[] args) throws IOException {
        ...
        LinkedTreeMap<String, String> oneCase = null;
        Map<String, LinkedTreeMap> op = new LinkedTreeMap<>();
        ArrayList<String> error_idx = new ArrayList<>();
//        int cnt = 0;
...
//            System.out.println("simplified testMethod: " + simplified_testMethod);
                oneCase.put("test", simplified_testMethod);
...
//            System.out.println("simplified focalMethod: " + simplified_focalMethod);
                oneCase.put("fm", simplified_focalMethod);
        ...
        // write error_idx to file
        FileWriter fileWriter0 = new FileWriter(
                new File("12-26-error.json")
        );
        gson.toJson(error_idx, fileWriter0);
        fileWriter0.flush();
        fileWriter0.close();


        System.out.println(error_idx.size());
        System.out.println(op.size());
        Gson gson_output = new GsonBuilder().setPrettyPrinting().create();
        // output op to json
        String op_json = gson_output.toJson(op);
        try (FileWriter fi = new FileWriter("12-26-output.json")) {
            fi.write(op_json);
        } catch (Exception e) {
//            e.printStackTrace();
        }
